...
struct SendImageView: View {
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Text("Images are checked locally, uploaded only over this host's SFTP connection, and inserted without pressing Return.")
                }
    ...
    private var statusSection: some View {
        ...
        case .failed:
            Section("Transfer") {
                Label(container.sendImageErrorMessage ?? "Image upload failed.", systemImage: "exclamationmark.triangle")
    ...
    private func sendClipboardImage() {
        ...
        guard let data = imageTypes.lazy.compactMap({ pasteboard.data(forPasteboardType: $0) }).first else {
