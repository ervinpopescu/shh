...
public final class LiveSFTPRepository: SFTPRepository, SFTPRestrictedUploader, RemoteFileRepository,
    @unchecked Sendable
{
    ...
    public func upload(
        ...
        try await upload(
            from: localURL, to: remotePath, permissions: permissions.rawValue, progress: progress)
    }
